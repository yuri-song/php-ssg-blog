          ...
          <g id="Avataaar" stroke-width="1" fill-rule="evenodd" mask="url(#mask-4)">
            ...
            <g id="Clothing/Blazer-+-Shirt" transform="translate(0.000000, 170.000000)">
              ...
              <g id="Shirt" transform="translate(32.000000, 29.000000)">
                ...
                <use id="Clothes" fill="#E6E6E6" xlink:href="#react-path-1"></use>
                ...
                <g id="Shadowy" opacity="0.599999964" mask="url(#react-mask-2)" fill-opacity="0.16" fill="#000000">
            ...
            <g id="Face" transform="translate(76.000000, 82.000000)" fill="#000000">
              ...
              <g id="Eyebrow/Outline/Angry" fill-opacity="0.599999964" fill-rule="nonzero">
                <path
                ...
                <path
                  ...
                  id="Eyebrow"
                  transform="translate(84.999934, 13.470064) scale(-1, 1) translate(-84.999934, -13.470064) "></path>
              </g>
            </g>
            <g id="Top" stroke-width="1" fill-rule="evenodd">
              ...
              <g id="Mask"></g>
              <g id="Top/Accesories/Hat" mask="url(#react-mask-13)">
                <g transform="translate(-1.000000, 0.000000)">
                  <g id="Hat" stroke-width="1" fill-rule="evenodd" transform="translate(1.000000, 0.000000)">
                    ...
                    <path
                      ...
                      fill="#1F333C" mask="url(#react-mask-14)"></path>
                    <ellipse id="Hipster" fill="#1F333C" mask="url(#react-mask-14)" cx="132" cy="87.5" rx="122"
                      ry="57.5"></ellipse>
                    <ellipse id="Very" fill="#15232A" mask="url(#react-mask-14)" cx="132" cy="82" rx="62" ry="25">
                    </ellipse>
                  </g>
                </g>
              </g>
